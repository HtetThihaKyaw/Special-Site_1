(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const observerConfigs = [
            { selector: '.head_kv', threshold: 0.1 },
            { selector: '#head_para', threshold: 0.1 },
            { selector: '.jobs', threshold: 0.1 },
            { selector: '.job_titles', threshold: 0.1 },
            { selector: '.advantages', threshold: 0.1 },
            { selector: '.advantages_img', threshold: 0.1 },
            { selector: '.home_manners', threshold: 0.1 },
            { selector: '.manners', threshold: 0.1 },
            { selector: '.imgs_slide', threshold: 0.1 },
            { selector: '.slide', threshold: 0.1 },
            { selector: '.map', threshold: 0.1 },,
            { selector: '.faq_header  h3', threshold: 0.1 },
            { selector: '.faq_3', threshold: 0.1 }, 
            { selector: '.comment_1', threshold: 0.1 },
            { selector: '.int_head', threshold: 0.1 },
            { selector: '.container_1, .container_2, .container_3, .container_4, .container_5', threshold: 0.1 },
            { selector: '.friends_catch', threshold: 0.2 },
            { selector: '.teacher_head, .teacher_1, .teacher_2, .teacher_3, .teachers_catch', threshold: 0.2 },
            { selector: '#kv_head3', threshold: 0.1 },
            { selector: '.project_teams', threshold: 0.1 },
            { selector: '.team_para, .event, .graphic, .seminar_t, .hotpage, .main', threshold: 0.1 },
